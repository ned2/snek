...
class Theme:
    ...
    name: str
    primary_color: str  # CSS color string
...
class ThemeManager:
    ...
    def _create_default_themes(self) -> List[Theme]:
        ...
        return [
            ...
            Theme(name="Sunset", primary_color="yellow"),  # Use standard yellow
            Theme(name="Royal", primary_color="magenta"),
            Theme(name="Cherry", primary_color="red"),
        ]
    
    def get_theme_for_level(self, level: int) -> Theme:
        """Get the appropriate theme for a given level."""
        # Cycle through themes as levels increase
