...
from snek.constants import SNEK_ASCII_ART, SNEK_TITLE
    ...
    def test_theme_colors_are_valid_rich_colors(self):
        ...
        for theme in manager.themes:
            ...
            try:
                ...
                pytest.fail(f"Theme '{theme.name}' has invalid color '{theme.primary_color}': {e}")
    ...
    def test_theme_colors_are_valid_textual_colors(self):
        ...
        for theme in manager.themes:
            ...
            try:
                ...
                if theme.primary_color in ['black', 'red', 'green', 'yellow', 
                ...
                pytest.fail(f"Theme '{theme.name}' has invalid Textual color '{theme.primary_color}': {e}")
    ...
    def test_theme_color_rendering(self):
        ...
        for theme in manager.themes:
            try:
                ...
                pytest.fail(f"Failed to render text with theme '{theme.name}' color '{theme.primary_color}': {e}")
